<?php
    ...
    if(isset($_POST["update"])){
        ...
        if (!empty($new_product_image)) {
            move_uploaded_file($new_product_tmpimage, "C:/xampp/htdocs/Assignment-Website/admin_panel/includes/product_images/$new_product_image");
        } else {
...
<form action="" method="post" enctype="multipart/form-data" class="p-4">
    ...
    <a href="products.php?delete=<?php echo $product_id?>" class="btn btn-danger">Delete Product</a>
    </div>
</form>
