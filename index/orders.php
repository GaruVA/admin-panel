<?php
    ...
    */
    ...
    $sql_select_user = "SELECT * FROM users WHERE user_ip = '$ip_address'";
    ...
    $sql_insert_order = "INSERT INTO `orders` (user_id,order_invoice,order_status,order_amount,order_payment,order_date) VALUES ($user_id,$order_invoice,'$order_status',$order_amount,'$order_payment',NOW());";
    $result_insert_order = mysqli_query($conn, $sql_insert_order);
    $sql_delete_cart="DELETE FROM `cart` WHERE ip_address='$ip_address';";
    ...
    if(isset($_POST['submit'])){
      ...
      $sql_select_order = "SELECT  * FROM `orders` WHERE order_invoice=$order_invoice && user_id=$user_id;";
      ...
      $sql_insert_delivery = "INSERT INTO `delivery` (order_id,delivery_firstname,delivery_lastname,delivery_address,delivery_address_city,delivery_address_state,delivery_contact) VALUES ($order_id,'$firstname','$lastname','$address','$city','$state','$contact');";
